---
title: "Stanford CS109 Lecture 23｜Midterm 2 Practice：複習不是重抄公式，而是先辨認題目中的隨機對象、未知量與資料生成方式。"
date: 2026-08-22
category: learning
type: deep-dive
...
series:
  ...
  order: 24
tldr: "複習不是重抄公式，而是先辨認題目中的隨機對象、未知量與資料生成方式。"
description: "逐講導讀 Stanford CS109 Summer 2026 Lecture 23：把 CLT、bootstrap、entropy 與 MLE 串成解題流程，並標示官方公開材料與缺口。"
draft: false
---

> 🌏 [English version](/posts/learning/2026-08-22-stanford-cs109-lecture-23-midterm-two-practice-en)

這是 [Stanford CS109 導讀](/series/stanford-cs109)的第 24 篇，對應 **Stanford CS109, Summer 2026, Lecture 23**（Aug 3），官方 schedule 題目是 **Midterm 2 Practice**，講者為 Chris Gregg。本文只依[官方 schedule](https://web.stanford.edu/class/cs109/schedule.html)、[講次頁](https://web.stanford.edu/class/cs109/schedule.html)與[課程讀本](https://probabilitycoders.stanford.edu/spr26)整理可驗證的範圍。

本講材料完整度標為 **L1**。schedule 明列此講；navbar 無 Lecture 23，無公開錄影與完整投影片。因此本文說明公開教材能支持的概念與推導，不把未公開錄影中的內容寫成講者原話。

## 這堂課要解決什麼

這一講的中心是把 CLT、bootstrap、entropy 與 MLE 串成解題流程。一句話抓住它：**複習不是重抄公式，而是先辨認題目中的隨機對象、未知量與資料生成方式。**
