---
title: "Stanford CS109 Lecture 24 | Diffusion: Diffusion models decompose hard generation into many small conditional denoising steps."
date: 2026-08-22
category: learning
type: deep-dive
...
series:
  ...
  order: 25
tldr: "Diffusion models decompose hard generation into many small conditional denoising steps."
description: "A lecture-by-lecture guide to Stanford CS109 Summer 2026 Lecture 24, covering forward noising, reverse denoising, and conditional distributions with explicit source gaps."
draft: false
---

> 🌏 [中文版](/posts/learning/2026-08-22-stanford-cs109-lecture-24-diffusion-models)

This is article 25 in [Reading Stanford CS109](/series/stanford-cs109), covering **Stanford CS109, Summer 2026, Lecture 24** (Aug 5). The canonical schedule title is **Diffusion**, taught by an unnamed guest lecturer. This guide stays within the verifiable scope of the [official schedule](https://web.stanford.edu/class/cs109/schedule.html), [lecture page](https://web.stanford.edu/class/cs109/lectures/24-Diffusion), and [course reader](https://probabilitycoders.stanford.edu/spr26).

Material fidelity is **L1**. schedule 與講次頁可用; 標為 guest lecture，但官網未公布講者姓名；無公開錄影. This article therefore explains what the public artifacts support; it does not present inaccessible recordings as lecture quotations.

## What problem does this lecture solve?

The lecture centers on forward noising, reverse denoising, and conditional distributions. Its one-sentence takeaway is: **擴散模型把困難的生成問題拆成許多小型條件去噪步驟。**
...
- schedule 與講次頁可用.
- 標為 guest lecture，但官網未公布講者姓名；無公開錄影.
...
- [Lecture 24: Diffusion](https://web.stanford.edu/class/cs109/lectures/24-Diffusion)
