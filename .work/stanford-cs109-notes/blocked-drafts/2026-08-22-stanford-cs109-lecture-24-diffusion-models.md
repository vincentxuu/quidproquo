---
title: "Stanford CS109 Lecture 24｜Diffusion：擴散模型把困難的生成問題拆成許多小型條件去噪步驟。"
date: 2026-08-22
category: learning
type: deep-dive
...
series:
  ...
  order: 25
tldr: "擴散模型把困難的生成問題拆成許多小型條件去噪步驟。"
description: "逐講導讀 Stanford CS109 Summer 2026 Lecture 24：前向加噪、反向去噪與條件分布，並標示官方公開材料與缺口。"
draft: false
---

> 🌏 [English version](/posts/learning/2026-08-22-stanford-cs109-lecture-24-diffusion-models-en)

這是 [Stanford CS109 導讀](/series/stanford-cs109)的第 25 篇，對應 **Stanford CS109, Summer 2026, Lecture 24**（Aug 5），官方 schedule 題目是 **Diffusion**，講者為 未具名客座講者。本文只依[官方 schedule](https://web.stanford.edu/class/cs109/schedule.html)、[講次頁](https://web.stanford.edu/class/cs109/lectures/24-Diffusion)與[課程讀本](https://probabilitycoders.stanford.edu/spr26)整理可驗證的範圍。

本講材料完整度標為 **L1**。schedule 與講次頁可用；標為 guest lecture，但官網未公布講者姓名；無公開錄影。因此本文說明公開教材能支持的概念與推導，不把未公開錄影中的內容寫成講者原話。

## 這堂課要解決什麼

這一講的中心是前向加噪、反向去噪與條件分布。一句話抓住它：**擴散模型把困難的生成問題拆成許多小型條件去噪步驟。**
