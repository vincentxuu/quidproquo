---
title: "Stanford CS109 Lecture 25 | Beyond Classification: Classification evaluates one prediction; sequential decisions must account for actions changing future data."
date: 2026-08-22
category: learning
type: deep-dive
...
series:
  ...
  order: 26
tldr: "Classification evaluates one prediction; sequential decisions must account for actions changing future data."
description: "A lecture-by-lecture guide to Stanford CS109 Summer 2026 Lecture 25, covering moving from label prediction to sequential decisions with explicit source gaps."
draft: false
---

> 🌏 [中文版](/posts/learning/2026-08-22-stanford-cs109-lecture-25-beyond-classification)

This is article 26 in [Reading Stanford CS109](/series/stanford-cs109), covering **Stanford CS109, Summer 2026, Lecture 25** (Aug 6). The canonical schedule title is **Beyond Classification**, taught by Chris Gregg. This guide stays within the verifiable scope of the [official schedule](https://web.stanford.edu/class/cs109/schedule.html), [lecture page](https://web.stanford.edu/class/cs109/lectures/25-Reinforcement1), and [course reader](https://probabilitycoders.stanford.edu/spr26).
...
The lecture centers on moving from label prediction to sequential decisions. Its one-sentence takeaway is: **分類只評估一次預測；序列決策還要處理行動如何改變下一筆資料。**
