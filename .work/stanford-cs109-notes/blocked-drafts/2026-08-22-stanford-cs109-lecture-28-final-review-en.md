---
title: "Stanford CS109 Lecture 28 | Review Session: The course reduces to four moves: count, model, infer, and decide."
date: 2026-08-22
category: learning
type: deep-dive
...
series:
  ...
  order: 29
tldr: "The course reduces to four moves: count, model, infer, and decide."
description: "A lecture-by-lecture guide to Stanford CS109 Summer 2026 Lecture 28, covering a full-course map from axioms to machine learning with explicit source gaps."
draft: false
---

> 🌏 [中文版](/posts/learning/2026-08-22-stanford-cs109-lecture-28-final-review)

This is article 29 in [Reading Stanford CS109](/series/stanford-cs109), covering **Stanford CS109, Summer 2026, Lecture 28** (Aug 12). The canonical schedule title is **Review Session**, taught by Chris Gregg. This guide stays within the verifiable scope of the [official schedule](https://web.stanford.edu/class/cs109/schedule.html), [lecture page](https://web.stanford.edu/class/cs109/lectures/28-Final-Review), and [course reader](https://probabilitycoders.stanford.edu/spr26).
...
The lecture centers on a full-course map from axioms to machine learning. Its one-sentence takeaway is: **全課程可以濃縮成四個動作：數清楚、建模型、做推論、下決策。**
...
- [Lecture 28: Review Session](https://web.stanford.edu/class/cs109/lectures/28-Final-Review)
