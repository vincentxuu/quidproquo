...
- [Agents Companion](https://www.kaggle.com/whitepaper-agent-companion) -- Google (February 2025). The Design Patterns section lists four — Sequential, Hierarchical, Collaborative, Competitive; the six named Hierarchical, Diamond, Peer-to-Peer, Collaborative, Response Mixer and Adaptive Loop come from the Patterns in Use section built around the in-car case study
