...
到了 2024 年 3 月，Kimi 進一步將 context window 擴展到 **2,000,000 中文字元**，支持使用者直接上傳整本書、長篇論文、完整程式碼庫進行分析和問答。
...
最初的 Kimi Chat 是一個面向消費者的聊天產品，主打長文本理解和中文對話能力。它在中國市場迅速獲得使用者，特別是學生、研究者和知識工作者群體。
...
- **K2 Thinking**（2025 年 11 月）：256K context，支持 200-300 次連續工具呼叫，訓練成本僅約 $460 萬
...
- **Agent Swarm**：能自主派遣最多 **100 個子 agent** 並行工作，執行高達 1,500 次工具呼叫，效率是單 agent 的 4.5 倍
...
- **成長速度**：K2.5 上線 20 天的營收超過 2025 全年；海外收入已超越國內；全球付費使用者月增長 170%
...
對開發者來說，K2.5 的 OpenAI 兼容 API、極具競爭力的定價、以及開源部署選項，讓它成為一個值得認真考慮的選項——特別是在 agentic 工作流程和中文場景中。

如果你還沒試過 Kimi，建議從一個需要大量工具呼叫的 agent 任務開始，或者丟一份超長文件進去。這兩個方向是 Kimi 目前最有說服力的地方。
