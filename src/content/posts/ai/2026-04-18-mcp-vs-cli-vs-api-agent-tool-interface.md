...
**2026-05-10 後記**：Anthropic 11/4 的 Code execution with MCP 出來後，「生成 code」這條路走出具體 pattern——Code Mode（lazy import + runtime）。展開寫在〈[Code Mode：把 tool definition 從 context 搬進 code](/posts/ai/2026-05-10-code-mode-mcp-runtime-pattern)〉。
