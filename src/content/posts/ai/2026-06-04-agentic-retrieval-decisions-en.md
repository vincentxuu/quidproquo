...
- **Parallel multi-query**: RAG-Fusion (arXiv:2402.03367) has the LLM generate 3-5 query variants for parallel retrieval, then aggregates with RRF -- expanding the hit surface. See the on-site article on [multi-query expansion](/posts/ai/2026-03-12-multi-query-expansion-en) for more detail.
...
Representative loop designs: ReAct (arXiv:2210.03629) interleaves reasoning and action, feeding action results back into the next reasoning step (on-site: [Agentic RAG and the ReAct Loop](/posts/ai/2026-03-12-agentic-rag-react-loop-en)); Plan-and-Solve (arXiv:2305.04091) drafts a plan first then executes steps one by one (on-site: [Plan-and-Execute RAG](/posts/ai/2026-03-12-plan-and-execute-rag-en)); Self-RAG / CRAG provide reflection loops (on-site: [Corrective RAG](/posts/ai/2026-03-12-corrective-rag-crag-en)). Three stopping conditions to choose from: documents are sufficiently relevant, the answer is grounded (hallucination grader passes), or the iteration limit is reached.
