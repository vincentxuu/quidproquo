...
**Put validity into the total cost.** AWS is 3 years, Google 2, NVIDIA and Databricks 2. AWS explicitly allows only a retake; PMLE also requires one today, but comes with a 50% renewal code, and continuing-education renewal already covers four other Google certifications with more promised. Microsoft's free online renewal assessment is still the cheapest of the group.
