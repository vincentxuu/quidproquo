...
**iPAS intermediate**: three characteristics shape preparation. First, complete past papers are public, so diagnose with real questions. Second, subjects 2 and 3 have included **code-interpretation questions** since the second 2025 session; the official [notice](https://ipd.nat.gov.tw/ipas/certification/AIAP/news/ffdba0fcdbda40baadeef2a1bdc0230e) (in Mandarin) says code-type questions are projected at roughly 25% of the paper, "in the form of single-choice questions and question sets" — note the **question sets**, where one fragment feeds several questions and one misreading costs you all of them. It's a question type where reading isn't the same as knowing; print the snippets and trace the values by hand. Third, check the intermediate subject-exemption rules in the official downloads section before you start: they may remove one subject from your workload entirely.
