...
Nothing on the official pages mentions auditing from outside. The only paid door was [XCS224U](https://online.stanford.edu/courses/xcs224u-natural-language-understanding), whose most recent cohort ran in spring 2025 — and Stanford Online has since taken the course down entirely (re-checked 26 August 2026), closing even that door.
...
**Not available: XCS224U's course materials and TAs.** That version is paid — and as of the 26 August 2026 re-check, Stanford Online's page reads "as of May 19, 2025, this course is no longer available." Even the paid route is gone.
...
- **Things I could not confirm**: (1) who teaches the Spring 2026-27 offering — the ExploreCourses instructor field is empty (re-checked 26 August 2026; CS224N and CS336 instructors are filled in for adjacent quarters, confirming this is an unassigned slot rather than missing data), Potts' teaching page currently goes no further than 2024-25, and the GitHub repo shows no sign of new-term preparation. The circumstantial evidence points to Potts returning: his Linguistics department chair term expired in August 2025 and his Amazon Scholar role ended in December 2024 — one academic year after stepping down, the course is back on the schedule. But this can't be stated as fact. (2) Why the course went three years without an offering — no official page explains it, but the background filled in substantially on 26 August 2026. At the personal level, the department chair term (Sep 2020 – Aug 2025) and the Amazon Scholar role (Oct 2022 – Dec 2024) cover exactly the two skipped years, and since January 2025 he has been co-founder and Chief Scientist of [Bigspin AI](https://bigspin.ai), an AI-agent monitoring startup; his public activity across 2025–26 is all external keynotes and webinars, with zero teaching on record — strong evidence for a shift in focus, though "he won't come back" remains speculation. At the university level, XCS224U's discontinuation wasn't isolated either: after Stanford cut $140M from its budget with layoffs, the [Office of the Vice Provost for Digital Education was shut down outright in January 2026](https://stanforddaily.com/2026/01/18/stanford-digital-education-shuts-doors/) (Stanford Daily), and the paid self-paced course lines were sunset in batches — low-volume products went first, while popular ones like XCS224N are still enrolling. He kept teaching other courses throughout, so "too busy to teach" doesn't hold; an ExploreCourses XML reverse lookup confirms he was personally PI of the last on-campus offering (Spring 2023). (3) Whether people outside Stanford can audit the on-campus class — the Stanford Bulletin's [auditing policy](https://bulletin.stanford.edu/academic-polices/enrollment/auditing) explicitly limits audit to matriculated students, postdocs, visiting scholars, and faculty/staff; outsiders need the paid Permit to Attend route with instructor, department, and Registrar approval — practically speaking, no free seat. On the paid remote side, see below: XCS224U was formally discontinued in May 2025 (the same sweep retired XCS330, while XCS224N is still enrolling), and Stanford Online offers only a generic "periodically sunset" line with no per-course reason. (4) The data-loading problem above, which I inferred from three public documents rather than by building the environment and running it.
