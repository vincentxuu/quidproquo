...
- **The textbook**: not available for free. The assigned book is Koller and Friedman's *Probabilistic Graphical Models: Principles and Techniques* (MIT Press), which you buy. Of the six further readings on the site, only [MacKay's *Information Theory, Inference, and Learning Algorithms*](http://www.inference.org.uk/mackay/itila/book.html) is a free online copy posted by the author. Bishop, Murphy, and Darwiche all route through the Stanford library, closed from outside. **And the official PDF link for Wainwright and Jordan's *Graphical Models, Exponential Families, and Variational Inference* now returns a 404** — that's the assigned companion reading for week nine. A stable public copy lives in the [Princeton course archive](https://www.cs.princeton.edu/courses/archive/fall11/cos597C/reading/WainwrightJordan2008.pdf) (verified HTTP 200 on 26 August 2026).
- **Lecture slides**: not available. The syllabus on the site lists topics and textbook sections only, with no PDFs attached.
- **Recordings**: not available. The site's Lecture Videos link points to an external tool on `canvas.stanford.edu` that requires a login. Two tiers of substitute exist: CMU 10-708 Probabilistic Graphical Models has [Eric Xing's complete Spring 2020 recordings](https://www.cs.cmu.edu/~epxing/Class/10708-20/) (same topic, more advanced; the [Spring 2019 version](https://www.youtube.com/@CMU-10-708-PGM) runs 55 videos), and Ermon and Kuleshov themselves published the official tutorial [*Probabilistic Graphical Models: A Concise Tutorial*](https://arxiv.org/abs/2507.17116) in July 2025 — rewritten directly from the CS228 notes, making it the most authoritative public version of the current material.
- **Assignments**: the official versions are not available — in recent offerings everything goes out on Ed, and the only public artifact is a [LaTeX answer template](https://cs.stanford.edu/~ermon/cs228/hwtemplate.tex). But community mirrors of past exams exist: [florist-notes/CS228_PGM](https://github.com/florist-notes/CS228_PGM) collects problem PDFs and programming parts for hw1–hw5, plus five final exams from 2006–2016 (the 2016 one with solutions), self-described as gathered from public resources. The problems lag the current offering by years — fine for practice, useless for checking answers.
...
So the self-study path is clear and narrow: **you get a complete text, no recordings, no grader, and assignments only through a years-stale mirror.** The site's "if you can comfortably complete homework 1 you have the background" check half-works for anyone outside — this quarter's HW1 is still something you can't get.
...
What's more informative is where both courses stand now. On ExploreCourses, CS236's status is `Last offered: Autumn 2023`, and its course site still carries the title "CS236 - Fall 2023" — the same shape as CS228's site frozen at Winter 2023-24. Neither course is currently running; the former is already scheduled for Spring 2027 with Ermon listed as PI, while CS228 did not run at all in 2025-26 (empty sections on ExploreCourses) but is listed in the 2026-27 Winter catalog with instructor TBD. As for why both went dark, no official page explains it — but the timeline speaks for itself: Ermon taught the final offerings of both courses personally, and since July 2024 he has been CEO of [Inception Labs](https://techcrunch.com/2025/02/26/inception-emerges-from-stealth-with-a-new-type-of-ai-model/), a diffusion-LLM startup. The teaching gap coincides exactly with the startup years (details in the appendix). These courses are paused, not cancelled.
...
- **Dead links** (all tested 2026-08-21): the K3 interactive simulation in the structure learning chapter, `pgmlearning.herokuapp.com/k3LearningApp`, returns HTTP 404; the same-family links in the d-separation and variable elimination chapters have been repointed at Wayback snapshots and open fine. In the further-reading list on the course site, the Wainwright & Jordan PDF at `www.eecs.berkeley.edu/~wainwrig/Papers/WaiJor08_FTML.pdf` returns HTTP 404, and the usual `people.eecs.berkeley.edu` alternative path 404s as well; a stable public copy was later found in the Princeton course archive (linked in the textbook section above).
...
- [Inception emerges from stealth — TechCrunch](https://techcrunch.com/2025/02/26/inception-emerges-from-stealth-with-a-new-type-of-ai-model/) — the diffusion-LLM startup Ermon co-founded; the key to the teaching-gap timeline
- [From the Lab to the Frontier — Menlo Ventures](https://menlovc.com/perspective/from-the-lab-to-the-frontier-the-story-behind-inception/) — investor interview containing the "walk away from tenure" quote
