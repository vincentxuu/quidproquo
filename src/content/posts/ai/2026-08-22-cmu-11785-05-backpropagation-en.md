---
title: "CMU 11-785 Lecture 5: Training III: Backpropagation"
date: 2026-08-22
category: ai
...
> 🌏 [中文版](/posts/ai/2026-08-22-cmu-11785-05-backpropagation)

This article covers CMU 11-785 Spring 2026 **Lecture 5: Training III: Backpropagation**. Its primary evidence is the [official slide deck](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec5.BP.pdf) and [official YouTube recording](https://youtu.be/Pk2J64MbOuw). It reconstructs only what those materials support and does not invent classroom dialogue or unpublished remarks.
...
Tonight's minimum exercise is: **make a forward/backward shape table for a two-layer MLP and run a finite-difference check**. Work through a tiny input by hand, reproduce it in NumPy or PyTorch, and compare the results. If they differ, inspect shapes, indexing, and reductions before questioning the theory.
