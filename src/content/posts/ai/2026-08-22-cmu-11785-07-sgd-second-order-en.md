---
title: "CMU 11-785 Lecture 7: Training V: SGD and Second-order Methods"
date: 2026-08-22
category: ai
...
> 🌏 [中文版](/posts/ai/2026-08-22-cmu-11785-07-sgd-second-order)

This article covers CMU 11-785 Spring 2026 **Lecture 7: Training V: SGD and Second-order Methods**. Its primary evidence is the [official slide deck](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec7.stochastic_gradient.pdf) and [official YouTube recording](https://youtu.be/55EiuST418c). It reconstructs only what those materials support and does not invent classroom dialogue or unpublished remarks.
...
Tonight's minimum exercise is: **run three batch sizes on fixed data and record step noise and per-epoch time**. Work through a tiny input by hand, reproduce it in NumPy or PyTorch, and compare the results. If they differ, inspect shapes, indexing, and reductions before questioning the theory.
...
- [Lecture 7 slides](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec7.stochastic_gradient.pdf)
- [Lecture 7 official YouTube recording](https://youtu.be/55EiuST418c)
