---
title: "CMU 11-785 Lecture 11: CNNs III"
date: 2026-08-22
category: ai
...
type: guide
difficulty: 進階
tldr: "Spring 2026 Lecture 11 focuses on stacked convolutional architectures, feature hierarchies, and design tradeoffs. This guide follows the official slides and recording and adds a small self-check that does not depend on the enrolled-course grader."
description: "A bilingual guide to CMU 11-785 Spring 2026 Lecture 11: CNNs III."
draft: false
series:
...
> 🌏 [中文版](/posts/ai/2026-08-22-cmu-11785-11-cnn-three)

This article covers CMU 11-785 Spring 2026 **Lecture 11: CNNs III**. Its primary evidence is the [official slide deck](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec11.CNN3.pdf) and [official YouTube recording](https://youtu.be/V7OpTmQcj9c). It reconstructs only what those materials support and does not invent classroom dialogue or unpublished remarks.

## What this lecture addresses

The lecture centers on stacked convolutional architectures, feature hierarchies, and design tradeoffs. Keep three things separate while reading: the model or algorithm's definition, the objective it optimizes, and the actual computational flow. The first determines the allowed function family, the second states what training prefers, and the third controls memory, speed, and numerical stability.

As Lecture 11, this topic inherits the course's earlier language of representation and training while establishing components used later. Do not merely copy terminology. For each equation, label its input, output, learnable parameters, and gradient path.
...
Tonight's minimum exercise is: **capture three activation maps with hooks and inspect the loss of spatial resolution**. Work through a tiny input by hand, reproduce it in NumPy or PyTorch, and compare the results. If they differ, inspect shapes, indexing, and reductions before questioning the theory.
...
- [Lecture 11 slides](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec11.CNN3.pdf)
- [Lecture 11 official YouTube recording](https://youtu.be/V7OpTmQcj9c)
