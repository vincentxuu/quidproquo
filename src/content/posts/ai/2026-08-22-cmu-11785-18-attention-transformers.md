---
title: "CMU 11-785 Lecture 18：Attention 與 Transformer"
date: 2026-08-22
category: ai
...
> 🌏 [English version](/posts/ai/2026-08-22-cmu-11785-18-attention-transformers-en)

本篇對應 CMU 11-785 Spring 2026 的 **Lecture 18: Attention and Transformers**。主要證據是[官方投影片](https://deeplearning.cs.cmu.edu/S26/documents/slides/lec18.attention.pdf)與[官方 YouTube 錄影](https://youtu.be/jL8AnyntOEQ)；下文只整理兩者能支持的內容，不補寫課堂問答或未公開的講者說法。
...
今晚的最小練習是：**用三個 token 手算 attention score、softmax 與加權和**。先用極小輸入手算一輪，再以 NumPy 或 PyTorch 重做，最後比較兩者。若結果不同，先檢查 shape、索引與 reduction，之後才懷疑理論。
