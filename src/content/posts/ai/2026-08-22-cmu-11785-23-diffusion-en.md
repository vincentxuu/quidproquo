---
title: "CMU 11-785 Lecture 23: Diffusion Models"
date: 2026-08-22
category: ai
...
type: guide
difficulty: 進階
tldr: "Spring 2026 Lecture 23 focuses on forward noising, reverse denoising, score or noise prediction, and sampling. This guide follows the official slides and recording and adds a small self-check that does not depend on the enrolled-course grader."
description: "A bilingual guide to CMU 11-785 Spring 2026 Lecture 23: Diffusion Models."
draft: false
series:
...
> 🌏 [中文版](/posts/ai/2026-08-22-cmu-11785-23-diffusion)

This article covers CMU 11-785 Spring 2026 **Lecture 23: Diffusion Models**. Its primary evidence is the [official slide deck](https://deeplearning.cs.cmu.edu/S26/documents/slides/Diffusion_S26_MB_V2.pdf) and [official YouTube recording](https://youtu.be/_gugiAREmSQ). It reconstructs only what those materials support and does not invent classroom dialogue or unpublished remarks.

## What this lecture addresses

The lecture centers on forward noising, reverse denoising, score or noise prediction, and sampling. Keep three things separate while reading: the model or algorithm's definition, the objective it optimizes, and the actual computational flow. The first determines the allowed function family, the second states what training prefers, and the third controls memory, speed, and numerical stability.

As Lecture 23, this topic inherits the course's earlier language of representation and training while establishing components used later. Do not merely copy terminology. For each equation, label its input, output, learnable parameters, and gradient path.
...
Tonight's minimum exercise is: **implement ten noising steps on one-dimensional data and plot each distribution**. Work through a tiny input by hand, reproduce it in NumPy or PyTorch, and compare the results. If they differ, inspect shapes, indexing, and reductions before questioning the theory.
...
- [Lecture 23 slides](https://deeplearning.cs.cmu.edu/S26/documents/slides/Diffusion_S26_MB_V2.pdf)
- [Lecture 23 official YouTube recording](https://youtu.be/_gugiAREmSQ)
