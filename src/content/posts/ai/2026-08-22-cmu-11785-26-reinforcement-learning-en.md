---
title: "CMU 11-785 Lecture 26: Reinforcement Learning"
date: 2026-08-22
category: ai
...
type: guide
difficulty: 進階
tldr: "Spring 2026 Lecture 26 focuses on states, actions, rewards, returns, values, and policy learning. This guide follows the official slides and recording and adds a small self-check that does not depend on the enrolled-course grader."
description: "A bilingual guide to CMU 11-785 Spring 2026 Lecture 26: Reinforcement Learning."
draft: false
series:
...
> 🌏 [中文版](/posts/ai/2026-08-22-cmu-11785-26-reinforcement-learning)
...
As Lecture 26, this topic inherits the course's earlier language of representation and training while establishing components used later. Do not merely copy terminology. For each equation, label its input, output, learnable parameters, and gradient path.
...
Tonight's minimum exercise is: **perform one Bellman backup in a small Gridworld**. Work through a tiny input by hand, reproduce it in NumPy or PyTorch, and compare the results. If they differ, inspect shapes, indexing, and reductions before questioning the theory.
...
- [Lecture 26 slides](https://deeplearning.cs.cmu.edu/S26/documents/slides/Reinforcement_Learning_S26.pdf)
- [Lecture 26 official YouTube recording](https://youtu.be/NTd9W1rqIYk)
