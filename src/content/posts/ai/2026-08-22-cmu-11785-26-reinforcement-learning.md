---
title: "CMU 11-785 Lecture 26：強化學習"
date: 2026-08-22
category: ai
...
type: guide
difficulty: 進階
tldr: "Spring 2026 Lecture 26 聚焦state、action、reward、return、value 與 policy learning；本文依官方 slides 與錄影重建主線，並提供不依賴課內 grader 的小型自我檢查。"
description: "CMU 11-785 Spring 2026 Lecture 26 雙語導讀：強化學習。"
draft: false
series:
...
> 🌏 [English version](/posts/ai/2026-08-22-cmu-11785-26-reinforcement-learning-en)

本篇對應 CMU 11-785 Spring 2026 的 **Lecture 26: Reinforcement Learning**。主要證據是[官方投影片](https://deeplearning.cs.cmu.edu/S26/documents/slides/Reinforcement_Learning_S26.pdf)與[官方 YouTube 錄影](https://youtu.be/NTd9W1rqIYk)；下文只整理兩者能支持的內容，不補寫課堂問答或未公開的講者說法。
...
課程把這個主題放在完整序列的第 26 講，因此它既承接前面的表示與訓練語言，也替後續模型建立共同元件。不要只抄名詞；每遇到一個公式，就標出輸入、輸出、可學參數與沿哪條路徑傳遞梯度。
...
今晚的最小練習是：**在小 Gridworld 寫出一次 Bellman backup**。先用極小輸入手算一輪，再以 NumPy 或 PyTorch 重做，最後比較兩者。若結果不同，先檢查 shape、索引與 reduction，之後才懷疑理論。
