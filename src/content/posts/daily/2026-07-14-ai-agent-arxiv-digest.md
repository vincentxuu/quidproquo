...
技術路線紮實，激活監控比 content filter 更底層，非同步場景下的優勢令人信服。但白盒假設是大限制：能自建 LLM serving 的平台才用得上，依賴雲端閉源 API 的用戶無緣。若補一個「黑盒近似版本」的實驗會更完整，目前感覺是 research prototype，距離通用產品化還有段路。
