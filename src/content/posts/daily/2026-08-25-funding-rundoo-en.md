...
tldr: "Rundoo closes a $30M Series B led by Battery Ventures, with Bessemer and CRV following on, bringing total funding to $48M. The bet isn't on an 'AI add-on layer' — it's on using an Agent to outright replace the legacy system-of-record that independent retailers have relied on for decades."
series:
  name: "AI Agent Funding"
  order: 9
---

> 🌏 [中文版](/posts/daily/2026-08-25-funding-rundoo)

## Funding Details

| Field | Value |
|---|---|
| Company | Rundoo (Redwood City, CA; GTM hub in Chicago) |
| Round | Series B |
| Amount | $30M |
| Lead | Battery Ventures (General Partner Michael Brown joins the board) |
| Follow-on | Bessemer Venture Partners, CRV (both existing investors) |
| Valuation | Undisclosed |
| Total raised | $48M |
| Founded | 2021 |
| Headcount | Undisclosed (only customer count and store footprint published) |
...
- [Rundoo Announces $48 Million in Financing](https://rundoo.ai/b/press-release/) — Rundoo official press release
- [Rundoo raises $30M to expand its AI-native operating system for small supply stores](https://siliconangle.com/2026/08/19/rundoo-raises-30m-to-expand-its-ai-native-operating-system-for-small-supply-stores/) — SiliconANGLE
- [Rundoo raises $30M to help independent retailers take on Home Depot and other big-box chains with AI](https://techstartups.com/2026/08/19/rundoo-raises-30m-to-help-independent-retailers-take-on-home-depot-and-other-big-box-chains-with-ai/) — Tech Startups
- [Rundoo Raises $30M in Series B Funding](https://www.finsmes.com/2026/08/rundoo-raises-30m-in-series-b-funding.html) — FinSMEs
- [AI Platform Rundoo Secures $30M Series B Funding Round](https://www.builtinsf.com/articles/rundoo-raises-30m-series-b-20260819) — Built In San Francisco
