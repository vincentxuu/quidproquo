...
tldr: "Stability AI closed a $76M Series B led jointly by Universal Music, Warner Music, Sony Music, and EA, bringing total funding to $232M. It is the first AI company to secure direct equity investment from all three major record labels simultaneously — signaling that copyright holders are shifting from 'sue AI' to 'invest in AI.'"
series:
  name: "AI Agent Funding"
  order: 10
---

> 🌏 [中文版](/posts/daily/2026-08-26-funding-stability-ai)

## Funding Details

| Field | Value |
|---|---|
| Company | Stability AI (founded in London, now primarily US-based) |
| Round | Series B |
| Amount | $76M |
| Lead investors | No single lead; joint investment from Universal Music Group (UMG), Warner Music Group (WMG), Sony Music Entertainment, and Electronic Arts (EA) |
| Follow-on | AMD Ventures, Pacific Alliance Ventures, plus returning investors Coatue, Greycroft, Kadmos Capital, Sean Parker, Eric Schmidt |
| Valuation | Undisclosed (~$1B at 2022 Series A; no new valuation announced) |
...
- [The Entertainment Industry's Biggest Names Back Stability AI in Latest Funding Round](https://uk.advfn.com/stock-market/share-news/The-Entertainment-Industrys-Biggest-Names-Back-Sta/99189179) — PR Newswire official press release (via ADVFN)
