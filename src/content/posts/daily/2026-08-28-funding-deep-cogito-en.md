...
tldr: "Deep Cogito raised a $43M Series A led by TQ Ventures, with Benchmark, Nexus Venture Partners, and Zscaler among participants, bringing total funding past $56M. The bet isn't on the next frontier model — it's on whether post-training itself can become a standalone, sellable business."
series:
  name: "AI Agent Funding"
  order: 13
---

> 🌏 [中文版](/posts/daily/2026-08-28-funding-deep-cogito)

## Funding Details

| Field | Value |
|---|---|
| Company | Deep Cogito (San Francisco, US) |
| Round | Series A |
| Amount | $43M |
| Lead investor | TQ Ventures |
| Follow-on | Benchmark, Nexus Venture Partners, Atreides Management, South Park Commons, Zscaler (customer and strategic investor) |
| Valuation | Undisclosed |
| Total raised | $56M+ |
| Founded | Undisclosed (founding team from Google AI Search) |
...
- [Deep Cogito Raises $43M Series A to Advance the Post-Training Engine for Frontier Intelligence](https://www.businesswire.com/news/home/20260826913379/en/) — Business Wire
- [Deep Cogito raises $43M to develop self-improving AI models](https://siliconangle.com/2026/08/26/deep-cogito-raises-43m-to-develop-self-improving-ai-models/) — SiliconANGLE
- [Deep Cogito raises $43M to help companies own their AI models](https://app.dealroom.co/news/note/deep-cogito-raises-43m-to-help-companies-own-their-ai-models) — Dealroom
