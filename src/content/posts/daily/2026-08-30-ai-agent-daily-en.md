...
**BreezeBlue Breeze TTS 2**: an open-weight voice model that topped Artificial Analysis's open-weight leaderboard — see today's model card. ([internal](/en/posts/daily/2026-08-30-model-breezeblue-breeze-tts-2-en))

**Pydantic AI v2.36.0**: adds `@durable_operation`, letting third-party durable-execution engines plug into agent fault-tolerant execution without touching any private API — see today's framework update. ([internal](/en/posts/daily/2026-08-30-framework-pydantic-ai-2.36.0-en))

### Pricing & API Lifecycle

OpenAI's Assistants API was officially retired on Aug 26 with no migration tool — see today's pricing tracker. ([internal](/en/posts/daily/2026-08-30-pricing-openai-assistants-api-sunset-en)) Separately, OpenAI cut GPT-5.6 Sol's official price to $4/$20 per million input/output tokens on Aug 21; layered on top of OpenRouter and Vercel AI Gateway promotions, Sol's OpenRouter usage jumped nearly 14x in August, a move that tracks pricing pressure from Anthropic and Chinese labs DeepSeek and Moonshot. ([source](https://startupfortune.com/openais-price-cut-on-gpt-56-sol-sent-openrouter-usage-up-nearly-14-times/))
...
**Claude Code Auto Mode bypassed**: a module-shadowing attack chain scored 60%–80% success; Anthropic closed the report as "working as designed" — see today's security alert. ([internal](/en/posts/daily/2026-08-30-security-claude-code-automode-module-shadowing-en))
...
**Japan & Korea**
LINE Yahoo announced it's spinning its existing AI assistant into a standalone app, "Agent i," launching in Japan in October, and disclosed that AI-agent-driven shopping already accounts for 20% of its e-commerce flow as of July. ([source](https://www.sankei.com/article/20260828-RJSFTQBT3VMEPN5EQIQZX4TG4U/)) A Korean startup weekly roundup also flagged LG Electronics seeding an enterprise AI coding platform, MachineFlow. ([source](https://en.wowtale.net/2026/08/29/234933/))
...
**Sarvam AI**: India's Series B expanded from a planned $200–250M to $300M+ at a $1.5B valuation, led by HCLTech with Nvidia participating. ([source](https://www.moneycontrol.com/artificial-intelligence/india-s-ai-funding-momentum-gathers-pace-as-startups-draw-bigger-growth-cheques-article-14017918.html)) The same week, Mumbai-based AI cloud startup **Neysa** raised $30M. ([source](https://economictimes.indiatimes.com/tech/startups/ai-startup-neysa-raises-30-million-in-funding-round-led-by-nttvc-others/articleshow/114432414.cms))
...
| Claude Code Auto Mode attack success rate | 60%–80% | [Internal security alert](/en/posts/daily/2026-08-30-security-claude-code-automode-module-shadowing-en) |
...
- 📄 [Model Card｜BreezeBlue Breeze TTS 2](/en/posts/daily/2026-08-30-model-breezeblue-breeze-tts-2-en)
- 📄 [Pricing Watch｜OpenAI Assistants API Officially Retired](/en/posts/daily/2026-08-30-pricing-openai-assistants-api-sunset-en)
- 📄 [Framework Update｜Pydantic AI 2.36.0](/en/posts/daily/2026-08-30-framework-pydantic-ai-2.36.0-en)
- 📄 [Security Alert｜Claude Code Auto Mode Bypassed](/en/posts/daily/2026-08-30-security-claude-code-automode-module-shadowing-en)
