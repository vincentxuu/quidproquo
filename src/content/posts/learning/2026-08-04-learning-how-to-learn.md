...
faq:
  - q: "重讀課本到底有沒有用？"
    a: "效果不好，而且是學生最常用的方法。Dunlosky 等人 2013 年評比 10 種學習技術，重讀被歸在「低效用」層；同一批研究裡 84% 的學生說自己會重讀、55% 把它列為第一順位策略。問題出在重讀「感覺」有效——第二遍讀起來比第一遍順，而那份流暢感會被誤讀成學會了。改用自我測驗，效果量相較重讀約為 +0.51。"
  - q: "自我測驗的效果到底多大？"
