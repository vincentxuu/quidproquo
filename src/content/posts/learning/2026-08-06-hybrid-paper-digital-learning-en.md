...
|---|---|---|---|
| [Allen et al. 2020](https://doi.org/10.1080/1041794X.2020.1764613) | 14 studies / 3,075 participants | r = −.142 (d ≈ 0.25) | Includes self-report and survey studies; does not separate distraction |
...
The founding study, [Mueller & Oppenheimer (2014)](https://doi.org/10.1177/0956797614524581), is in worse shape than most retellings suggest. [Urry et al. (2021)](https://www.victoriafloerke.com/s/Urryetal_PSCI_2021.pdf) ran a preregistered replication with N = 142 against the original's 65. The headline conceptual-application effect went from g = 0.34 to g = −0.13, flipping direction, and differing significantly from the original, t(139.03) = −2.78, p = .003. In [Morehead et al. (2019)](https://eric.ed.gov?Id=EJ1225471), even the group that took no notes at all did not fall significantly behind.
...
The 2024 high-density EEG study by [Van der Weel & Van der Meer](https://doi.org/10.3389/fpsyg.2023.1219945) found greater theta- and alpha-band connectivity during handwriting than typing, and got relayed everywhere as proof that handwriting is better for learning.
