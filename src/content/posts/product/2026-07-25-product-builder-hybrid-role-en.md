...
- **[Google](https://www.linkedin.com/posts/aagupta_the-head-of-product-on-google-ai-studio-and-activity-7425273148415336450-J1gH)** — the head of product for AI Studio and Gemini API, Logan Kilpatrick, dropped the PM title for Member of Technical Staff. But context matters: DeepMind is simultaneously hiring PMs with traditional titles at $183k–$320k base. One person changing a title is not the same as a company restructuring
- **[Cursor](https://www.linkedin.com/posts/mike-karr_cursor-has-40-engineers-and-zero-pms-4b-activity-7475484160590233600-m1lF)** — 40 engineers, 1 PM, 0 dedicated designers, [past $4B ARR](https://www.news.aakashg.com/p/ai-product-operating-model). OpenAI Codex is similar: 43 people covering 10–12 product surfaces that would need 150–240 at a traditional company
- **[Cars24](https://economictimes.indiatimes.com/industry/auto/auto-news/cars24-scraps-job-titles-and-hierarchy-in-ai-era-organisational-overhaul/articleshow/132157238.cms)** (Indian used-car platform) eliminated all job titles, grades, and org bands company-wide. Everyone is now **Builder**. Co-founder Vikram Chopra: "Every generation gets to question one assumption that previous generations took for granted. Ours may be the assumption that companies need to be organised the way they have been for the last hundred years." Revenue per employee up 50% and nearly 300bps of EBITDA improvement over 18 months
- **[Block](https://www.itnews.com.au/news/in-two-amazon-units-builder-replaces-traditional-job-titles-625330)** (Square's parent) started calling some managers **player-coach** — not the Builder label, but the same direction: managers who also build
