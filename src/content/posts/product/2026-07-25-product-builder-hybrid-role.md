...
- **[Amazon（Ring & Blink）](https://www.itnews.com.au/news/in-two-amazon-units-builder-replaces-traditional-job-titles-625330)** 在年度考核中直接砍掉所有傳統職稱，數百名員工統一改為 **Builder** 和 **Builder Lead**。CPO Jason Mitura 的內部備忘錄（Reuters 取得）：「我們用一個問題定義成功：你創造了多大範圍和規模的客戶價值？」
- **[Stripe](https://theskip.substack.com/p/inside-pm-at-stripe-what-comes-after)** 比多數公司更早讓 PM 變成 builder——新 PM 第一天就拿到最新模型和內部 coding agent。但他們已經在問下一個問題：當工程師能一夜跑五十個 agent，PM 驕傲地送 PR 到底有什麼意義？Kevin Yien（Stripe PM 主管）的說法：「不是一個功能吃掉另一個，是所有功能集體往上移一層」
- **[LinkedIn](https://www.lennysnewsletter.com/p/why-linkedin-is-replacing-pms)** 結束了行之有年的 APM 計畫，另設 **Associate Product Builder（APB）** track。[CPO Tomer Cohen 在 Miro Canvas 26 的說法](https://miro.com/blog/tomer-cohen-canvas-26/)：「我們替客戶想像這個未來，但內部還是切成 PM、設計、工程——這不合理了」
...
- **[Google](https://www.linkedin.com/posts/aagupta_the-head-of-product-on-google-ai-studio-and-activity-7425273148415336450-J1gH)** AI Studio 與 Gemini API 的產品負責人 Logan Kilpatrick 把頭銜從 PM 改成 Member of Technical Staff。不過 Aakash Gupta 的分析值得注意：DeepMind 同時在用傳統 PM 職稱招人，base $183k–$320k。一個人改頭銜不等於整個公司在動
- **[Cursor](https://www.linkedin.com/posts/mike-karr_cursor-has-40-engineers-and-zero-pms-4b-activity-7475484160590233600-m1lF)** 40 個工程師、1 個 PM、0 個專職設計師，[ARR 突破 $4B](https://www.news.aakashg.com/p/ai-product-operating-model)。OpenAI Codex 也類似：43 人覆蓋 10-12 個 product surface，傳統公司同樣範圍要 150-240 人
- **[Cars24](https://economictimes.indiatimes.com/industry/auto/auto-news/cars24-scraps-job-titles-and-hierarchy-in-ai-era-organisational-overhaul/articleshow/132157238.cms)**（印度二手車平台）砍掉全公司所有職稱、職等和組織層級，所有人統一稱為 **Builder**。共同創辦人 Vikram Chopra：「每一個世代都有機會質疑上一代視為理所當然的假設。我們的假設是：公司需要用過去一百年的方式來組織嗎？」18 個月後營收/人效提升 50%，EBITDA 改善近 300 個基點
- **[Block](https://www.itnews.com.au/news/in-two-amazon-units-builder-replaces-traditional-job-titles-625330)**（Square 母公司）開始把部分主管改稱 **player-coach**——不是 Builder 這個詞，但同一個方向：管理者也要動手做
