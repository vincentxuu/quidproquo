---
title: "Why Drones Only Fly for 30 to 45 Minutes: One Equation Gives the Answer, and the Cell Is Made in Taiwan"
date: 2026-08-08
type: deep-dive
category: tech
tags: [drone, battery, physics, molicel, supply-chain]
lang: en
tldr: "Hover power scales with takeoff weight to the 1.5, while battery energy scales linearly with weight — that single exponent gap decides everything. Returns on adding battery collapse fast: going from 0.3 to 0.6 kg buys 30% more flight time, 0.6 to 1.2 buys 9%, and 1.2 to 2.4 costs you 7%. The optimal battery fraction can be solved in closed form and comes out at two-thirds of takeoff weight — independent of propeller diameter, rotor count, efficiency and energy density alike. I assumed the regulatory weight thresholds would cap endurance; the maths says they roughly do not, since 250 g and 25 kg have similar theoretical ceilings. What does cap it is payload: on a 25 kg aircraft every extra kilogram costs about 2.9 minutes. Sixty minutes needs a 314 Wh/kg cell, and today's best high-drain cell is 242 Wh/kg — the Molicel P45B, made by E-One Moli Energy, a TCC Group company in Taiwan."
