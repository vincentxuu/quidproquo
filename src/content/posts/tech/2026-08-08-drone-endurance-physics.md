...
lang: zh-TW
tldr: "懸停功率跟起飛重量的 1.5 次方成正比，電池能量只跟重量的一次方成正比——這一個指數差讓加電池的報酬遞減得非常快，而最佳電池比例解出來是起飛重量的三分之二，跟槳徑、旋翼數、效率、能量密度全部無關。真正壓住續航的不是法規重量門檻是酬載：要飛 60 分鐘需要 314 Wh/kg 的電芯，今天最好的高倍率芯是 242 Wh/kg。"
