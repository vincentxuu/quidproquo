---
title: "pi-mono 深度導讀 15：Containerization、Sandbox、Permission Model——Gondolin、Docker、OpenShell、安全邊界"
date: 2026-08-31
type: project
category: tech
...
series:
  name: "pi-mono 深度導讀"
  order: 15
tldr: "Pi 為什麼不內建 Permission System、Gondolin Extension（微 VM 隔離）、Docker 整合模式、OpenShell 沙盒、Permission Model 設計哲學、三種容器化部署模式、安全邊界對比、micro-VM vs Container vs Process Isolation、Extension 如何實作沙盒。"
description: "深入 pi-mono 安全架構：Permission Model 設計哲學（不內建、交由使用者決定）、Gondolin Extension 實作微 VM 隔離、Docker 模式（Host/Container/VM 三層）、OpenShell Policy-controlled Sandbox、安全邊界對比表、Extension 實作沙盒的 Hook Points、容器化部署模式選擇指南。適合研究 AI Agent 安全架構、沙盒技術、容器化部署的工程師。"
draft: false
---

> 🌏 [English version](/en/posts/tech/2026-08-31-pi-mono-deep-dive-containerization-en)
