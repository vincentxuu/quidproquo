---
title: "pi-mono Deep Dive 14: Testing, Quality Gates, Supply-chain Hardening — Faux Provider, Browser Smoke, Biome, tsgo, Shrinkwrap, Trusted Publishing"
date: 2026-08-31
type: project
category: tech
...
series:
  ...
  order: 14
tldr: "Testing strategy: Faux Provider (no API key e2e), Vitest unit, Browser Smoke (real browser), Biome lint/format, tsgo type check, Pinned Deps, Shrinkwrap, Install Lock, npm Trusted Publishing, CI pipeline."
description: "Deep dive into pi-mono quality system: Faux Provider simulating LLM responses, Browser Smoke via Playwright verifying TUI rendering, Vitest unit coverage, Biome lint/format, tsgo native TypeScript check, Pinned Deps exact versions, Shrinkwrap locking transitive deps, Install Lock, npm Trusted Publishing OIDC, GitHub Actions CI pipeline. For engineers researching TypeScript project quality engineering and supply-chain security."
draft: false
---

> 🌏 [中文版](/posts/tech/2026-08-31-pi-mono-deep-dive-testing-quality)
