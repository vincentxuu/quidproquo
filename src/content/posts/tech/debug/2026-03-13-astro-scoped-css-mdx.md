...
- [Astro Scoped Styles 文件](https://docs.astro.build/en/guides/styling/#scoped-styles)
- [Astro `is:global` 指令](https://docs.astro.build/en/reference/directives-reference/#isglobal)
- [Astro MDX 整合](https://docs.astro.build/en/guides/integrations-guide/mdx/)
