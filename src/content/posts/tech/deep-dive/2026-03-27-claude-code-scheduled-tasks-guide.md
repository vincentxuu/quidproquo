---
title: "Claude Code Routines：讓 AI 在雲端自動幫你做事（前 Cloud Scheduled Tasks）"
date: 2026-03-27
type: guide
category: tech
...
這篇專注介紹 Routines。`/loop` 的介紹見 [/loop 排程功能](/posts/tech/2026-03-16-claude-code-loop-scheduling)，Remote Agent 的完整流水線見 [Remote Agent 自動開發](/posts/tech/deep-dive/2026-03-27-remote-agent-auto-dev-pipeline)。
