...
- [Message your other Claude Code sessions — Claude Code Docs](https://code.claude.com/docs/en/cross-session-messaging) — Cross-session messaging, `ListAgents` visibility, message safety boundaries, and version requirements
- [Manage costs effectively — Claude Code Docs](https://code.claude.com/docs/en/costs#agent-team-token-costs) — Official guidance on Agent Teams token costs, team size, and cost controls
...
- 2026-08-29: Aligned with the current official Agent Teams docs: corrected plan approval behavior, added `x` to stop a teammate, and updated the subagent messaging and teammateMode descriptions.
