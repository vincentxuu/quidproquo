...
export const ui = {
  'zh-TW': {
    ...
    'glossary.search': '搜尋',
    'nav.daily': '日報',
    'daily.title': 'Daily Digest',
    'daily.description': 'AI Agent 生態的每日學習紀錄',
    'daily.filter.all': '全部',
    'daily.filter.daily': '日報',
    'daily.filter.arxiv': 'Arxiv',
    'daily.filter.github': 'GitHub',
    'daily.filter.weekly': '週回顧',
    'daily.empty': '尚無日報。',
  },
  en: {
    'nav.home': 'Home',
    ...
    'nav.daily': 'Daily',
    'daily.title': 'Daily Digest',
    'daily.description': 'Daily learning log of the AI Agent ecosystem',
    'daily.filter.all': 'All',
    'daily.filter.daily': 'Daily',
    'daily.filter.arxiv': 'Arxiv',
    'daily.filter.github': 'GitHub',
    'daily.filter.weekly': 'Weekly',
    'daily.empty': 'No daily digest yet.',
  },
} as const;
