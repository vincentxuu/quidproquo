...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  search_page_source_vectorize_weight: '1',
  search_page_source_vectorize_timeout_ms: '2500',
  search_page_source_ai_search_enabled: '0',
  search_page_source_ai_search_visible: '0',
